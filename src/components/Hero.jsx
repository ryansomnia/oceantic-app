    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 text-white p-6 md:p-8">
          ...
          <a 
            href="#events" 
            className="bg-warm-gold text-white text-xl font-bold py-4 px-10 rounded-full hover:bg-yellow-700 transition duration-300 transform hover:scale-105 shadow-lg"
          >
            Explore Our Events
          </a>
        </div>
