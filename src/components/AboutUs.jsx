      ...
      <section id="about-us" className="py-20 bg-soft-gray text-dark-charcoal">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold text-oceanic-blue mb-12 relative pb-4">
            About <span className="text-aqua-accent">OCEANETIC</span>
          ...
          <div className="max-w-4xl mx-auto text-lg leading-relaxed">
            ...
            <p>
              From local championships to international grand prix, OCEANETIC brings professionalism, precision, and passion to every stroke. We believe in the power of water to unite, challenge, and transform. Join us in making waves!
            </p>
            {/* Anda bisa menambahkan gambar di sini */}
            {/* <img src="/images/about-us-team.jpg" alt="OCEANETIC Team" className="mt-10 rounded-lg shadow-lg mx-auto max-w-full h-auto" /> */}
          </div>
        </div>
      </section>
    );
